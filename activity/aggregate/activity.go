...
import (
	...
	"github.com/SteveNY-Tibco/labs-air-contrib/activity/aggregate/pipeline/support"
	"github.com/SteveNY-Tibco/labs-air-contrib/activity/aggregate/window"
...
func (a *Activity) Eval(ctx activity.Context) (done bool, err error) {
	...
	fmt.Printf(" --------------------------> In Eval function in = %v \n", in)
	emit, result := w.AddSample(in)
	fmt.Printf(" --------------------------> In Eval function result = %v \n", result)
	fmt.Printf(" --------------------------> In Eval function emit = %v \n", emit)
